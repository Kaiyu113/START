...
import { PostMainLikeCompTypes, Like, Comment } from "../type";
...
export default function PostMainLike({ post }: PostMainLikeCompTypes) {
      ...
      <div id={`PostMainLikes-${post?.id}`} className="relative mr-[75px]">
        <div className="absolute bottom-0 pl-2">
          ...
          <button className="text-center">
            ...
            <span className="text-xs text-gray-800 font-semibold">2</span>
          </button>
        </div>
      </div>
    </>
