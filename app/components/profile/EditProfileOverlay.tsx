            ...
            {!uploadedImage ? (
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center bg-[#ff707] text-white border rounded-md ml-3 px-3 py-[6px]"
                >
...
"
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center bg-[#f37fb2] text-white border rounded-md ml-3 px-3 py-[6px]"
                >
                  <span className="mx-4 font-medium text-[15px]">
                    {isUpdating ? (
                      <BiLoaderCircle
